...
import MapViewCalloutBar from '../../Components/MapViewCalloutBar'
import BuscaMapaBarActions from './reducer';
...
class MapaBar extends React.Component {
  /* ***********************************************************
  ...
  *************************************************************/
  ...
  calloutPress (location) {
    ...
    *************************************************************/
    console.log("TESTE CALLOUT")
    NavigationActions.barDetalhado(location)
  }
...
const mapStateToProps = (state) => {
  return {
    searchTerm: state.buscaMapaBar.searchTerm,
    results: state.buscaMapaBar.results
  }
}

const mapDispatchToProps = (dispatch) => {
  return {
    performSearch: (searchTerm) => dispatch(BuscaMapaBarActions.searchMapaBar(searchTerm)),
  }
}
